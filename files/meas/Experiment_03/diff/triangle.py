...
if not saved:
  ...
  waveform = 'TRIANGLE'  # waveform of the Inputsignal
  Amp = 0.5              # amplitude of the input signal
  downsampling = 64      # downsamplingrate (decimation factor)
  ...
  RP.tx_txt('SOUR1:FREQ:FIX ' + str(300))      # set frequency
...
s1 = ltspice.Ltspice('../../spice/diff/triangle/triangle-py.raw')
s1.parse()

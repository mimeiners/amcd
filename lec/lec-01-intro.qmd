...
## Design Project
*Design of a discrete or integrated analog biquad filter.* 
...
* Fundamentals of microelectronics
  ...
  * Control theory (frequency response, feedback, stability)
  * System theory (Laplace- and Z-transform)

* Prior exposure to SPICE, Matlab/Simulink, Python or equivalent
